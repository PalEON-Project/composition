...
if(cv) nmAdd <- "-cv" else nmAdd <- ""
save(holdOutCells, treeHoldOut, dataFull, nbhd, nbhdIndices, m1, m2, nTaxa, nCells, data, coord, taxa, file = paste0(file.path(dataDir, paste0('westernData', nmAdd, '.Rda'))))
